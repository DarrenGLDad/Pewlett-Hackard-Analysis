...
WHERE (birth_date BETWEEN '1952-01-01' AND '1955-12-31')
AND (hire_date BETWEEN '1985-01-01' AND '1988-12-31');
--Original, to create a table to export
SELECT first_name, last_name
...
-- Aliases Joining retirement_info and dept_emp tables
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
    de.to_date
...
-- Aliases Joining departments and dept_manager tables
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
SELECT * FROM retirees_dept;

SELECT * FROM salaries
ORDER BY to_date DESC;
-- comprehensive Employee info list
...
-- comprehensive list Department Retirees
